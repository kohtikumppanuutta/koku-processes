...
function inputMultiSections() {
    var day, hour, startDate, endDate, helperStartTime, helperEndTime, startTimeStr, startTimeHours, startTimeMinutes, endTimeStr, endTimeHours, endTimeMinutes, locat, duration, slotsPerDay;
    var counter, escapeGenerate;
    
    var counterArray = getSlotCount();
    
    if (counterArray[0] > 30) {
...
function addToRecipients() {
    ...
    while(childIterator.hasNext()) {
        ...
        if((chosen != null) && (chosen != 0)) {
            ...
            node.setAttribute("recipientsUid", vanhemmatUid);// Prestart --------------------------------------------------------------------------------------------------------------------------------------
function intalioPreStart() {
    var error, child, parent1, parent2;
...
function getSlotCount() {
    ...
    var day, hour, startDate, endDate, helperStartTime, helperEndTime, startTimeStr, startTimeHours, startTimeMinutes, endTimeStr, endTimeHours, endTimeMinutes, locat, duration, slotsPerDay, dayCount, totalSlots;
    var array = new Array();
