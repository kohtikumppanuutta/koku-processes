    ...
    <xsl:template match="fe:TIVA3Form">
		<xsl:copy>
            ...
            <xsl:element name="suostumustapa">        
            	<xsl:value-of select="//fe:Suostumus2_Suostumustapa/text()" />
            </xsl:element>
            ...
            <xsl:element name="suostumusajankohta">        
            	<xsl:value-of select="//fe:Suostumus2_Suostumusjankohta/text()" />
            </xsl:element>
            ...
            <xsl:element name="suostumuksenLisaTiedot">
            	<xsl:element name="additionalInfo">
            		<xsl:value-of select="//fe:Suostumus2_Lisatiedot/text()" />
            	</xsl:element>
            	<xsl:element name="attachmentUrl">
            		<xsl:value-of select="//fe:Suostumus2_Liite/text()" />
            	</xsl:element>
            	<xsl:element name="repository">
            		<xsl:value-of select="//fe:Suostumus2_Sailytyspaikka/text()" />
            	</xsl:element>
            </xsl:element>
